...
/* harmony import */ var _profile_edit_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./profile-edit.page.html?ngResource */ 3022);
/* harmony import */ var _profile_edit_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./profile-edit.page.scss?ngResource */ 6924);
...
let ProfileEditPage = class ProfileEditPage {
  constructor(auth, afs, loadingCtrl, toastr, modalController, alert) {
    this.auth = auth;
    this.afs = afs;
  ...
  undateAlertConfirm() {
    ...
    return (0,D_Hyman_Programming_Ionic_WordGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this.name && _this.email && _this.phone) {
        const alert = yield _this.alert.create({
          ...
          buttons: [{
            ...
            handler: () => {
              ...
              _this.modalController.dismiss(); //按下返回modalController消失
            ...
            handler: () => {
              ...
              _this.undateProfile(); //call undateProfile()
  ...
  undateProfile() {
    ...
    return (0,D_Hyman_Programming_Ionic_WordGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.afs.collection('user').doc(_this2.userId).set({
        'userName': _this2.name,
        'userEmail': _this2.email,
        'userPhone': _this2.phone,
        'editAt': Date.now()
      }, {
        merge: true
      }).then(() => {
        ...
        _this2.toast('更改成功!', 'success');
      }).catch(error => {
        loading.dismiss();

        _this2.toast('更改失敗!', 'danger');
      });

      _this2.modalController.dismiss(); //更改資料後modalController消失
...
ProfileEditPage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
  selector: 'app-profile-edit',
  template: _profile_edit_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  styles: [_profile_edit_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__]
})], ProfileEditPage);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,D_Hyman_Programming_Ionic_WordGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,D_Hyman_Programming_Ionic_WordGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,D_Hyman_Programming_Ionic_WordGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
module.exports = "ion-content {\n  --background:var(--ion-color-dark) url('gameBackground5.jpg') no-repeat center center/cover;\n}\n\nion-card {\n  box-shadow: -1px 11px 13px -6px rgb(87, 86, 86);\n  border-radius: 10px !important;\n  margin-left: 10px;\n  margin-right: 10px;\n  margin-top: 20px;\n}\n\nion-input {\n  font-size: 60%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
